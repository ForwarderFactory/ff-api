...
std::pair<ff::UploadStatus, std::string> ff::try_upload_forwarder(const netkit::http::server::request& req, database& db) {
    std::string json{};
...
std::pair<ff::UploadStatus, std::string> ff::try_upload_file(const netkit::http::server::request& req, database& db) {
    std::string json{};
